...
export type Settings={provider:'groq'|'grok'|'deepseek'|'openrouter';model:string;voiceId:string;slang:boolean;brainrot:boolean;theme:'light'|'dark'|'system';hasAiKey?:boolean;hasFishKey?:boolean};
